...
GameState.prototype.save = function() {
    ...
    LocalStore.set('store.gamestate', persist).done()
}

GameState.prototype.load = async function() {
    const persist = await LocalStore.get('store.gamestate')
...
GameState.prototype.updateRoles = function(clear) {
    ...
    if (this.playerNames.length < 5) {
        ...
        this.disabledReason = 'tooFewWithRoles'
    } else {
        this.disabledReason = null
        this.assignRoles()
    }
